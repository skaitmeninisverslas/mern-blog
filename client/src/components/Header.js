  ...
  render() {
    ...
    return(
      <div className="TOPBAR">
        ...
        <a className="TOPBAR__branding" href="/">Ugne</a>
            <div className="TOPBAR__socials">
              <a href={this.props.menu.socials.instagram}><i className="fab fa-instagram"></i></a>
              <a className="TOPBAR__socials-border" href={this.props.menu.socials.facebook}><i className="fab fa-facebook"></i></a>
            ...
            <div className="MENU__first">
              ...
              { this.state.category.map(category =>
                <li key={category._id} className="MENU__item"><a href={"/categories/" + category.title}>{category.title}</a></li>
              )}
              { this.state.page.map(pages =>
                <li key={pages._id} className="MENU__item"><a href={"/page/" + pages.title}>{pages.title}</a></li>
              )}
              </ul>
            </div>
            ...
            <div className="MENU__second">
              <div className="MENU__information">
                <div className="MENU__information-image"><img className="rounded-circle" src={this.props.menu.image} alt="" /></div>
                <div className="MENU__information-heading">{this.props.menu.title}</div>
                <div className="MENU__information-text">{this.props.menu.about}</div>
